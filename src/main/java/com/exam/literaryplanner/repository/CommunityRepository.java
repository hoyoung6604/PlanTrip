...
public interface CommunityRepository extends JpaRepository<Community, Integer> {
    ...
    @Query("""
        ...
        WHERE r.rvIdx = :rvIdx
    """)
    Optional<Community> findDetail(@Param("rvIdx") Integer rvIdx);
    ...
    """)
    List<Community> findByMIdxOrderByRvIdxDesc(@Param("mIdx") Integer mIdx);
    ...
    @Query("""
        ...
        ORDER BY r.rvIdx DESC
    """)
    List<Community> findByMIdxAndRvTitleContainingOrderByRvIdxDesc(
    ...
    @Query("""
        ...
        ORDER BY r.rvIdx DESC
    """)
    List<Community> searchOrderByLatestDesc(@Param("kw") String keyword,
    ...
    """)
    List<Community> searchOrderByStarDesc(@Param("kw") String keyword,
                                      @Param("minStar") Integer minStar,
                                      @Param("sIdx") Integer sIdx);
