...
<div class="container" style="padding:24px 0;">
  <div style="display:flex; align-items:flex-end; justify-content:space-between; gap:12px; margin-bottom:14px;">
    <div>
      ...
      <p style="margin:6px 0 0; color:#6b7280;">문의 작성</p>
    </div>
    ...
    <main style="flex:1; min-width:0;">
      <div style="border:1px solid #e5e7eb; border-radius:14px; background:#fff; padding:16px;">
        <div style="display:flex; align-items:center; justify-content:space-between; gap:10px;">
          <div>
            <div style="font-weight:800; font-size:16px;">문의 작성</div>
        ...
        <form action="${pageContext.request.contextPath}/support/qna" method="post"
          ...
          <textarea name="qCont" rows="10" required
                    ...
                    style="width:100%; padding:10px 12px; border:1px solid #e5e7eb; border-radius:12px; outline:none; resize:vertical;"></textarea>

          <div style="display:flex; gap:10px; margin-top:6px; flex-wrap:wrap;">
            <button type="submit" class="btn solid" style="border:0; cursor:pointer;">
              등록하기
            </button>
