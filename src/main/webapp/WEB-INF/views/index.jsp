					...
					<div class="container header-inner">
						...
						<nav class="nav">
							<div class="nav-dropdown" id="catWrap">
								<button class="nav-drop-btn" type="button" id="catBtn" aria-haspopup="true"
									aria-expanded="false">
									카테고리 <span class="chev" aria-hidden="true">▾</span>
								</button>
								<div class="nav-drop-menu" id="catMenu" role="menu" aria-label="카테고리">
									<a href="/spots/list?category=TOUR">관광지</a>
									<a href="/spots/list?category=STAY">숙소</a>
									<a href="/spots/list?category=ACT">문화/액티비티</a>
									<a href="/spots/list?category=FOOD">맛집</a>
								</div>
							</div>
						...
						<div class="header-right">
							...
							<j:if test="${not empty sessionScope.loginMember}">
								...
								<div class="hamburger" id="hmWrap">
									<button class="hamburger-btn" type="button" id="hmBtn" aria-label="메뉴"
						...
						<div class="container">
								...
								<div class="marquee" data-marquee>
									<div class="marquee__track" data-marquee-track>
										...
										<a class="post-card" href="/spot/mountain">
											<div class="post-img" style="background-image:url('/img/mountain.jpg')">
											</div>
											<div class="post-body">
							...
							<section class="block block-recommend">
								...
								<div class="recommend-wrap">
									<button class="arrow-btn arrow-left" type="button" aria-label="이전"
										onclick="scrollRecommend(-1)">
									...
									<button class="arrow-btn arrow-right" type="button" aria-label="다음"
										onclick="scrollRecommend(1)">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
											stroke="currentColor" stroke-width="2" stroke-linecap="round"
											stroke-linejoin="round">
