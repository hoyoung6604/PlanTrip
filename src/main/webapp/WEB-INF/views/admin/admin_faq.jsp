...
<header class="header is-solid">
  <div class="container header-inner">
    ...
    <nav class="nav">
      ...
      <a href="#" style="font-weight:700;">FAQ 작성</a>
    </nav>
...
<main class="wrap">
  <div class="card">
    <h2 style="margin:0 0 6px;">FAQ 작성</h2>
    <p style="margin:0;opacity:.7;">질문(제목)과 답변(내용)을 입력하세요.</p>
    ...
    <form action="${pageContext.request.contextPath}/admin/faq" method="post">
      ...
      <div class="actions">
        <a class="btn" href="${pageContext.request.contextPath}/admin/faqs"
