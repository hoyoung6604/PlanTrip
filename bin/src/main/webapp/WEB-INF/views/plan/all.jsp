...
<div class="container">
	<div class="header-section">
	    <a href="${pageContext.request.contextPath}/spots/category?cityId=${selectedCity}" 
	       style="text-decoration: none; color: #888; font-size: 14px; display: inline-block; margin-bottom: 15px;">
	       &lt; ${city.name} 지역 메인으로 돌아가기
	    </a>
